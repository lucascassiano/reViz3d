...
void loop() {
  ...
  Serial.print("{\"data\":["); //temperature data
  String data_colors = "";
  ...
  for (int i = 0; i < AMG88xx_PIXEL_ARRAY_SIZE; i++) {
    ...
    //for colors
    //float t = (float)pixels[i];
    //for temperature values
    data_colors += colorIndex; //camColors[colorIndex];
  ...
  Serial.print("],");
  Serial.print("\"colors\":["); //temperature data
  Serial.print(data_colors);
  Serial.print("],");
  
  Serial.print("\"temp\":"); //thermistor (C)
